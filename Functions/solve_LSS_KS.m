...
% ArXiv e-print ...., 2024.
%% --------------------------------------------------------------
function [V,Y] = solve_LSS_KS(A,E,B,tol,k,optsKS) % All this function has a cost that is O(n)
% Iteration 0
...
if flagRE==0
    ...
    V0=V; V=V0; n=size(V,2); AV=E\(A*V); VAV=V'*AV; BV=V'*B;
    for i=1:k
